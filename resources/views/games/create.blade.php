...
@section('content')
    <div class="row">
        ...
        <form class="row g-3" action="{{ route('games.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="col-md-6">
            ...
            <div class="col-md-6">
                ...
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu scroll-menu list-group-flush" aria-labelledby="dropdownMenuButton1">
                        @foreach ($genres as $genre)
                            <li class="list-group-item"><input type="checkbox" name="genres[]" value="{{ $genre->id }}"
                                    id="{{ $genre->name }}" class="form-check-input"><label
            ...
            <div class="col-md-6">
                ...
                <input type="file" onchange="new_image_validation()" name="image" id="image"
